...
public class Convert {
     ...
     * convert it to IntervalType
     *
     * @param position the position in data[]
     * @param data     a byte array
     * @return the short integer
     * @throws java.io.IOException    I/O errors
     * @throws ClassNotFoundException Read Object errors
     */
    public static IntervalType getIntervalTypeValue(int position, byte[] data)
            throws java.io.IOException {
        IntervalType value = new IntervalType();
        value.setStart(getIntValue(position, data));
        value.setEnd(getIntValue(position + 4, data));
        return value;
    }
     ...
     * @throws java.io.IOException I/O errors
     */
    public static void setIntervalTypeValue(IntervalType value, int position, byte[] data)
            throws java.io.IOException {
        /* creates a new data output stream to write data to
         * underlying output stream
         */
        setIntValue(value.getStart(), position, data);
        setIntValue(value.getEnd(), position + 4, data);
    }
