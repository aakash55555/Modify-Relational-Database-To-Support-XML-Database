 ...
 */
public class ITIndexScan extends Iterator {
    ...
    public ITIndexScan(
        ...
        try {
            ...
            throw new IndexException(e, "BTIndexScan.java: TupleUtilsException caught from TupleUtils.setup_op_tuple()");
        } catch (InvalidRelation e) {
            throw new IndexException(e, "BTIndexScan.java: InvalidRelation caught from TupleUtils.setup_op_tuple()");
        }
        ...
        try {
            ...
            throw new IndexException(e, "BTIndexScan.java: Heapfile error");
        }
        ...
        try {
            ...
            throw new IndexException(e, "BTIndexScan.java: Heapfile not created");
        }
...
//                } catch (Exception e) {
//                    throw new IndexException(e, "BTIndexScan.java: BTreeFile exceptions caught from BTreeFile constructor");
//                }
//
//                try {
//                    indScan = (BTFileScan) BTIndexUtils.BTree_scan(selects, indFile);
//                } catch (Exception e) {
//                    throw new IndexException(e, "BTIndexScan.java: BTreeFile exceptions caught from BTIndexUtils.BTree_scan().");
//                }
//
//                break;
            ...
            case IndexType.interval_Index:
                ...
                try {
                    ...
                    throw new IndexException(e, "BTIndexScan.java: BTreeFile exceptions caught from ITTreeFile constructor");
                }

                try {
                    indScan = (intervalFileScan) ITIndexUtils.intervalTree_scan(selects, indFile);
                } catch (Exception e) {
                    throw new IndexException(e, "BTIndexScan.java: BTreeFile exceptions caught from BTIndexUtils.ITTree_scan().");
                }
            ...
            case IndexType.None:
            default:
                throw new UnknownIndexTypeException("Only ITTree index is supported so far");
    ...
    public Tuple get_next()
        ...
        try {
            ...
            throw new IndexException(e, "BTIndexScan.java: BTree error");
        }
...
//                    int count = 0;
//                    for (int i = 0; i < _fldNum; i++) {
//                        if (_types[i].attrType == AttrType.attrInterval )
//                            count++;
//                    }
//                    s_sizes[0] = _s_sizes[count - 1];
            ...
            try {
                ...
                throw new IndexException(e, "BTIndexScan.java: getRecord failed");
            }
...
//            }
            ...
            if (indScan instanceof intervalFileScan) {
                try {
                    ((intervalFileScan) indScan).DestroyintervalTreeFileScan();
                } catch (Exception e) {
                    throw new IndexException(e, "IntervalTree error in destroying index scan.");
                }
            }
