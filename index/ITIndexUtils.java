...
/**
 * BTIndexUtils class opens an index scan based on selection conditions.
...
public class ITIndexUtils {
     ...
     * @throws btree.KeyNotMatchException
...
//                throw new InvalidSelectionException("BTIndexUtils.java: Invalid selection condition");
//            }
//
//            KeyClass key;
//
...
//            System.err.println("Error -- in BTIndexUtils.BTree_scan()");
//            return null;
//        } else {
...
//                default:
//                    // error condition
//                    throw new UnknownKeyTypeException("BTIndexUtils.java: Only Integer and String keys are supported so far");
//            }
//        } // end of else
//
//    }
...
//    }
    ...
    public static intervalTree.IndexFileScan intervalTree_scan(CondExpr[] selects, intervalTree.IndexFile indFile)
            ...
            PinPageException,
            IteratorException,
            ConstructPageException, KeyNotMatchException, IteratorException, ConstructPageException, PinPageException, UnpinPageException {
        ...
        if (selects[1] == null) {
            ...
            switch (type.attrType) {
                case AttrType.attrInterval:
                    if (IT.keyCompare(((intervalKey) key1), ((intervalKey) key2)) < 0) {
    ...
    private static intervalTree.KeyClass getValueITree(CondExpr cd, AttrType type, int choice)
        ...
        switch (type.attrType) {
            case AttrType.attrInterval:
                if (choice == 1) return new intervalKey(cd.operand1.intervalType);
                else return new intervalKey(cd.operand2.intervalType);
            default:
                throw new UnknownKeyTypeException("BTIndexUtils.java: Only Integer and String keys are supported so far");
        }
