 ...
 * key and data abstraction.  The ITLeafPage and ITIndexPage code
 ...
 * <p>
 * Furthermore, the IT<*>Page classes need
 ...
 * or the whole intervalTree tree structure or all leaf pages.
 */

public class IT implements GlobalConst {
    ...
    public final static int keyCompare(KeyClass key1, KeyClass key2)
        ...
        if ((key1 instanceof intervalKey) && (key2 instanceof intervalKey)) {
            ...
            return (((intervalKey) key1).getKey().getStart())
                    - (((intervalKey) key2).getKey().getStart());
    ...
    protected final static KeyDataEntry getEntryFromBytes(byte[] from, int offset,
        ...
        try {
            ...
            if (keyType == AttrType.attrInterval) {
                key = new intervalKey(
                        (Convert.getIntervalTypeValue(offset, from)));
    ...
    protected final static byte[] getBytesFromEntry(KeyDataEntry entry)
        ...
        try {
            ...
            if (entry.key instanceof intervalKey) {
                Convert.setIntervalTypeValue(((intervalKey) entry.key).getKey(),
                        0, data);
    ...
    /**
     * used for debug: to print a page out. The page is either ITIndexPage,
     * or ITLeafPage.
     *
     ...
     * @throws ConstructPageException      error for IT page constructor
    ...
    public static void printPage(PageId pageno, int keyType)
        ...
        if (sortedPage.getType() == NodeType.INDEX) {
            ITIndexPage indexPage = new ITIndexPage((Page) sortedPage, keyType);
            System.out.println("");
    ...
    /**
     * For debug. Print the intervalTree tree structure out
     *
     * @param header the head page of the intervalTree tree file
     * @throws IOException                 error from the lower layer
     * @throws ConstructPageException      error from IT page constructor
    ...
    public static void printintervalTree(intervalTreeHeaderPage header)
        ...
        System.out.println("");
        System.out.println("");
        System.out.println("---------------The intervalTree Tree Structure---------------");
    ...
    /**
     * For debug. Print all leaf pages of the intervalTree tree  out
     *
     * @param header the head page of the intervalTree tree file
     * @throws IOException                 error from the lower layer
     * @throws ConstructPageException      error for IT page constructor
    ...
    public static void printAllLeafPages(intervalTreeHeaderPage header)
        ...
        System.out.println("");
        System.out.println("");
        System.out.println("---------------The intervalTree Tree Leaf Pages---------------");
