...
public class ITLeafPage extends ITSortedPage {
    ...
    /**
     * associate the ITLeafPage instance with the Page instance,
     * also it sets the type to be NodeType.LEAF.
     *
    ...
    /**
     * new a page, associate the ITLeafPage instance with the Page instance,
     * also it sets the type to be NodeType.LEAF.
     *
     * @param keyType either AttrType.attrInteger or AttrType.attrString.
     *                Input parameter.
     ...
     * which  provide an iterator interface to the records on a ITLeafPage.
     *
    ...
    public KeyDataEntry getFirst(RID rid)
        ...
        try {
            ...
            entry = IT.getEntryFromBytes(getpage(), getSlotOffset(0), getSlotLength(0),
     ...
     * iterator interface to the records on a ITLeafPage.
     *
    ...
    public KeyDataEntry getNext(RID rid)
        ...
        try {
            ...
            entry = IT.getEntryFromBytes(getpage(), getSlotOffset(i), getSlotLength(i),
                    keyType, NodeType.LEAF);
     ...
     */
    boolean redistribute(ITLeafPage leafPage, ITIndexPage parentIndexPage,
        ...
        try {
            if (direction == -1) { // 'this' is the left sibling of leafPage
                ...
                if ((getSlotLength(0) + available_space() + 8) > ((MAX_SPACE - DPFIXED) / 2)) {
                    ...
                    KeyDataEntry firstEntry;
                    firstEntry = IT.getEntryFromBytes(getpage(), getSlotOffset(0),
