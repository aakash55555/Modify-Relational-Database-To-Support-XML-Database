...
public class ItIndexNestedLoopsJoins extends Iterator {
    CondExpr[] scanFilter;
     ...
     */
    public ItIndexNestedLoopsJoins(AttrType in1[],
                                   int len_in1,
                                   short t1_str_sizes[],
                                   AttrType in2[],
                                   int len_in2,
    ...
    public Tuple get_next()
        ...
        do {
            ...
            if (get_from_outer == true) {
                ...
                if (indexIterator != null)     // If this not the first time,
                {
                    // close scan
                    indexIterator.close();
                }
                ...
                try {
                    //inner = hf.openScan();
                    scanFilter = getScanFilterForIntIndex(2, outer_tuple.getIntervalFld(2));
                    indexIterator = new ITIndexScan(new IndexType(IndexType.interval_Index), "xml.sort",
                            "int.index", getTupleAttrTypes(1), getTupleStringShorts(1), 3, 3,
            ...
            // RID rid = new RID();
            while ((inner_tuple = indexIterator.get_next()) != null) {
