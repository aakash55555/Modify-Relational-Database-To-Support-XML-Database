...
public class IndexNestedLoopsJoins extends Iterator {
    ...
    private Heapfile hf;
    private Scan inner;
    private iterator.Iterator indexIterator;
    ...
    public Tuple get_next()
        ...
        do {
            ...
            if (get_from_outer == true) {
                ...
                try {
                    //inner = hf.openScan();
                    scanFilter = getScanFilterForTagIndex(2, rname);
                    if (rname.contains("xml.sort")) scanFilter = null;
                    indexIterator = new BTIndexScan(new IndexType(IndexType.B_Index), "xml.sort",
