            ...
            while (temp_ptr != null) {
                ...
                switch (temp_ptr.type1.attrType) {
                    ...
                    case AttrType.attrSymbol:
                        ...
                        relationType = temp_ptr.relationType;
                        break;
                    case AttrType.attrInterval:
                        ...
                        intervalType_flag = temp_ptr.flag;
                    default:
                        break;
                }
                ...
                try {
                    ...
                    if (temp_ptr.op.attrOperator == AttrOperator.aopGT && relationType == 1) {
                        int parentOft2 = tuple2.getIntFld(fld2 + 1);
                        IntervalType t1_it = t1.getIntervalFld(fld1);
                        if (t1_it.getStart() != parentOft2) {
                            comp_res = -3;
                        }
                    }
                ...
                switch (temp_ptr.op.attrOperator) {
                    ...
                    case AttrOperator.aopNE:
                        if (comparison_type.attrType == 5) {
                            if (intervalType_flag == 0) {
                                if (comp_res != 3) op_res = true;
                            } else if (intervalType_flag == 1) {
                                if (comp_res == 0) op_res = true;
                            }
                        } else if (comp_res != 0) op_res = true;
                        break;
                    case AttrOperator.aopLE:
                        if (comparison_type.attrType != 5 && comp_res <= 0) op_res = true;
                        break;
